...
class BM3(GeneralRecommender):
    ...
    def get_norm_adj_mat(self, interaction_matrix):
        ...
        SciPy newer versions no longer support dok_matrix._update(), and
        dok_matrix.update() explicitly raises NotImplementedError. Build the
        bipartite graph directly as COO/CSR instead.
        """
        ...
        # Convert possible duplicate user-item interactions to binary edges.
